...
void mavlinkSendHUDAndHeartbeat(void)
{
    ...
    mavlink_msg_vfr_hud_pack(0, 200, &mavMsg,
        ...
        mavGroundSpeed, // FIXME: Air speed might be different from ground speed if there is wind, but using GS is better than zero
    ...
    switch(masterConfig.mixerMode)                               // Set system_type here
    {
        case MIXER_TRI:
